...
const createCategories = async (req) => {
  ...
  if (check) throw new BadRequestError("Category Name Already Exist");
...
const updateCategories = async (req) => {
  ...
  // cari categories dengan field name dan id selain dari yang dikirim dari params, $ne = kecuali id ini
  const check = await Categories.findOne({
    name,
    organizer: req.user.organizer,
    _id: { $ne: id },
